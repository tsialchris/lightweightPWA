  ...
  FONT_SCALE_MAP: {
    ...
    m_font: {
      ...
      150: {
        ...
        "chrome": "calc(16px + 1vmin)"
      }, //20px
      175: {
        "safari": "calc(1.6rem/1.75 + 1.25vmin)",
        "chrome": "calc(16px + 1.25vmin)"
      }, //22px
      200: {
      ...
      300: {
        ...
        "chrome": "calc(16px + 2.1vmin)"
      } //28px
    },
    l_font: {
      100: {
        "safari": "calc(1.6rem + 1.7vmin)",
        "chrome": "calc(16px + 1.7vmin)"
      }, //22px
      110: {
      ...
      175: {
        ...
        "chrome": "calc(16px + 2.4vmin)"
      }, //27px
      200: {
        "safari": "calc(1.6rem/2 + 2.7vmin)",
        "chrome": "calc(16px + 2.7vmin)"
      }, //30px
      250: {
        "safari": "calc(1.6rem/2.5 + 3.1vmin)",
        "chrome": "calc(16px + 3.1vmin)"
      }, //33px
      300: {
        "safari": "calc(1.6rem/3 + 3.5vmin)",
        "chrome": "calc(16px + 3.5vmin)"
      } //35px
    },
    xl_font: {
      100: {
        "safari": "calc(1.6rem + 2.3vmin)",
        "chrome": "calc(16px + 2.3vmin)"
      }, //24px
      110: {
        "safari": "calc(1.6rem/1.1 + 2.5vmin)",
        "chrome": "calc(16px + 2.5vmin)"
      }, //24.5px
      130: {
      ...
      150: {
        ...
        "chrome": "calc(16px + 3vmin)"
      }, //27px
      175: {
        "safari": "calc(1.6rem/1.75 + 3.2vmin)",
        "chrome": "calc(16px + 3.2vmin)"
      },//30px
      200: {
      ...
      250: {
        ...
        "chrome": "calc(16px + 4vmin)"
      },//36px
      300: {
        "safari": "calc(1.6rem/3 + 4.5vmin)",
        "chrome": "calc(16px + 4.5vmin)"
      },//38px
    }
