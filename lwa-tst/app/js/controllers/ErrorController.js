...
function ErrorController() {
  ...
  switch (errorCode) {
    ...
    case "013":
    case "099":
      document.querySelector(".modal-title.header-title").setAttribute("translate", "product_not_found_title");
      document.querySelector(".modal-content .error-text").innerHTML = `<p> <b translate="product_not_found"></b></p> <p><span translate="err_code"></span><span>${errorCode}</span></p>`;
      break;
    /* case "011":
